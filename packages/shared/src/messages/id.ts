...
export const id: Record<keyof typeof en, string> = {
  ...
  'meetingLang.ui': 'Ikut bahasa antarmuka',
  ...
  'ext.summary.step.saving': 'Menyimpan',
  ...
  'ext.summary.exportDesktop': '⬇ Desktop',
  'ext.summary.desktopSent': 'Terkirim ke Companion Desktop.',
  'ext.summary.desktopFailed': 'Gagal mengirim ke Desktop: {error}',
  'ext.summary.desktopNotConnected': 'Companion Desktop belum terhubung. Periksa Pengaturan → Integrasi.',
  ...
  'ext.docgen.standardTemplate': 'Standar',
  'ext.decisions.title': 'Keputusan & Carry-over',
  'ext.transcript.highlights': 'Sorotan',
  'ext.integrations.calendarClientId': 'Google OAuth client id (kalender)',
  'ext.templates.name': 'Nama',
  'ext.kb.standing': 'berlaku',
  'ext.kb.chronology': 'Kronologi',
  'ext.sidebar.historyEmpty': 'Kosong',
  'ext.tracker.tokenHint': 'Disimpan terenkripsi (AES-GCM), sama seperti API key provider.',
  'ext.transcription.apiKey': 'API key transkripsi',
  'ext.data.importing': 'Mengimpor…',
  'ext.data.importAction': 'Impor transcript / audio',
  'ext.data.importShare': 'Impor berkas share',
  'ext.data.exportAudit': 'Ekspor log audit (JSON)',
