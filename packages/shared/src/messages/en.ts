...
export const en = {
  ...
  'ext.summary.step.saving': 'Saving',
  ...
  'ext.summary.desktopSent': 'Sent to Companion Desktop.',
  'ext.summary.desktopFailed': 'Failed to send to Desktop: {error}',
  'ext.summary.desktopNotConnected': 'Companion Desktop is not connected. Check Settings → Integrations.',
  ...
  'ext.docgen.standardTemplate': 'Standard',
  'ext.decisions.title': 'Decisions & carry-over',
  'ext.transcript.highlights': 'Highlights',
  'ext.integrations.calendarClientId': 'Google OAuth client id (calendar)',
  'ext.templates.name': 'Name',
  'ext.kb.standing': 'standing',
  'ext.kb.chronology': 'Chronology',
  'ext.sidebar.historyEmpty': 'Nothing yet',
  'ext.tracker.tokenHint': 'Stored encrypted (AES-GCM), the same as the provider API key.',
  'ext.transcription.apiKey': 'Transcription API key',
  'ext.data.importing': 'Importing…',
  'ext.data.importAction': 'Import transcript / audio',
  'ext.data.importShare': 'Import a share file',
  'ext.data.exportAudit': 'Export the audit log (JSON)',
